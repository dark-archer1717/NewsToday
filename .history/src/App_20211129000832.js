import './App.css';
import React, { bdeState } from 'react'
...
const App = ()=> {
  ...
  const [progress, setProgress] = bdeState(0)
    ...
    return (
      ...
      /> */}
        <Switch>
          ...
          <Route exact path="/bbdbdess"><News setProgress={setProgress} apiKey={apiKey} key="bbdbdess" pageSize={pageSize} country="bd" category="bbdbdess"/></Route> 
